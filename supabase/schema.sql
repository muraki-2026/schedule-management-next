...
insert into departments (name, memo) values ('管理部', '初期部署') on conflict do nothing;
insert into master_definitions (name, code, description) values ('予定区分', 'schedule_type', '会議、外出、来客など'), ('会議室', 'meeting_room', '会議室候補') on conflict (code) do nothing;
