...
function ScheduleModal({ draft, setDraft, users, types, locations, save, remove }: { draft: DraftSchedule; setDraft: (d: DraftSchedule | null) => void; users: UserProfile[]; types: MasterItem[]; locations: MasterItem[]; save: (e: React.FormEvent) => void; remove: (id: string) => void }) {
